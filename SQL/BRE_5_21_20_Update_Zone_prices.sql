...
DROP TABLE public."zone6akeepers";
SELECT res.* 
INTO Zone6aKeepers
FROM public."Zone6a" AS z6a, public."homes_df" AS res
WHERE st_intersects(z6a.geom, res.geom)
	AND res.parval > 150000;	

DROP TABLE public."zone7akeepers";
SELECT res.* 
INTO Zone7aKeepers
FROM public."Zone7a" AS z7a, public."homes_df" AS res
WHERE st_intersects(z7a.geom, res.geom)
	AND res.parval > 150000;	

DROP TABLE public."zone7bkeepers";
SELECT res.* 
INTO Zone7bKeepers
FROM public."Zone7b" AS z7b, public."homes_df" AS res
WHERE st_intersects(z7b.geom, res.geom)
	AND res.parval > 200000;

DROP TABLE public."zone7ckeepers";
SELECT res.* 
INTO Zone7cKeepers
FROM public."Zone7c" AS z7c, public."homes_df" AS res
WHERE st_intersects(z7c.geom, res.geom)
	AND res.parval > 300000;
...
AS SELECT * FROM public."zone1akeepers" UNION
	...
	SELECT * FROM public."zone5nkeepers" UNION
	SELECT * FROM public."zone6akeepers" UNION
	SELECT * FROM public."zone7akeepers" UNION
	SELECT * FROM public."zone7bkeepers" UNION
	SELECT * FROM public."zone7ckeepers";	